...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.FId).HasName("PK__tAboutUs__D9F8227C80511007");
        ...
        {
            entity.HasKey(e => e.FId).HasName("PK__tCart__D9F8227C593A0158");
        ...
        {
            entity.HasKey(e => e.FId).HasName("PK__tFAQ__D9F8227C2CB1A4AE");
        ...
        {
            entity.HasKey(e => e.FId).HasName("PK__tImg__D9F8227CE4FA7C17");
        ...
        {
            entity.HasKey(e => e.FId).HasName("PK__tInvoice__D9F8227C5EF8639C");
        ...
        {
            entity.HasKey(e => e.FId).HasName("PK__tInvoice__D9F8227CCC3C4AD0");
        ...
        {
            entity.HasKey(e => e.FId).HasName("PK__tOrder__D9F8227CD49DBE2E");
        ...
        {
            entity.HasKey(e => e.FId).HasName("PK__tOrderLi__D9F8227C128F9193");
        ...
        {
            entity.HasKey(e => e.FId).HasName("PK__tPerson__D9F8227C11825FB7");
        ...
        {
            entity.HasKey(e => e.FId).HasName("PK__tProduct__D9F8227C0C2FAF0E");
        ...
        {
            entity.HasKey(e => e.FId).HasName("PK__tProvide__D9F8227C5723DE29");
        ...
        {
            entity.HasKey(e => e.FId).HasName("PK__tPurchas__D9F8227C5308A642");
        ...
        {
            entity.HasKey(e => e.FId).HasName("PK__tPurchas__D9F8227CDAC70D40");
